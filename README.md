...
> A skin for jivelite with a different look that displays extra information on the *Now Playing* screen (rating, audio meta data, lyrics, status icons, genre, year...). You can also rate a track directly on the *Now Playing* screen of some devices.<br>
